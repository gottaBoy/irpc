...
import com.gottaboy.irpc.core.LoadBalanceStrategy;
...
import com.gottaboy.irpc.spring.Client;
...
public class LoadBalanceUtil {
	 ...
	 * 日志记录器
	 */
	private static Logger logger = LoggerFactory.getLogger(LoadBalanceUtil.class);
