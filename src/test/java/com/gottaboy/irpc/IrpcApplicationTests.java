package com.gottaboy.irpc;

import com.gottaboy.irpc.core.GeneralService;
import com.gottaboy.irpc.core.RpcContext;
import com.gottaboy.irpc.service.UserDto;
import com.gottaboy.irpc.service.UserService;
...
class IrpcApplicationTests extends TestCase {

    /**
     * 日志记录器
     */
    Logger logger = Logger.getLogger(IrpcApplicationTests.class);
    ...
    public void testServer_base() throws Exception {
        ...
        ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("irpc-provider-base.xml");
        context.start();
        System.in.read();
    }
    ...
    public void testClient_base() throws Exception {
        ...
        ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("irpc-consumer-base.xml");
        context.start();
        /**
         * 服务调用
         */
    ...
    public void testServer_version() throws Exception {
        ...
        ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("irpc-provider-version.xml");
        context.start();
        System.in.read();
    }
    ...
    public void testClient_version() throws Exception {
        ...
        ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("irpc-consumer-version.xml");
        context.start();
        /**
         * 服务调用
         */
    ...
    public void testClient_timeout() throws Exception {
        ...
        ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("irpc-consumer-timeout.xml");
        context.start();
        /**
         * 服务调用
         */
    ...
    public void testServer_weight() throws Exception {
        ...
        ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("irpc-provider-weight.xml");
        context.start();
        System.in.read();
    }
    ...
    public void testClient_direct() throws Exception {
        ...
        ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("irpc-consumer-direct.xml");
        context.start();
        /**
         * 服务调用
         */
    ...
    public void testClient_cluster_fault() throws Exception {
        ...
        ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("irpc-consumer-cluster-fault.xml");
        context.start();
        /**
         * 服务调用
         */
        UserService userService = (UserService)context.getBean("userService");
        BigDecimal a = new BigDecimal("123");
        logger.info("a/0:" + userService.exceptionDivideZero(a));
        System.in.read();
    }
    ...
    public void testClient_cache() throws Exception {
        ...
        ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("irpc-consumer-cache.xml");
        context.start();
        /**
         * 服务调用
         */
    ...
    public void testClient_async() throws Exception {
        ...
        ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("irpc-consumer-async.xml");
        context.start();
        /**
         * 服务调用
         */
    ...
    public void testClient_search_local() throws Exception {
        ...
        ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("irpc-consumer-search-local.xml");
        context.start();
        /**
         * 服务调用
         */
    ...
    public void testClient_intercept() throws Exception {
        ...
        ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("irpc-consumer-intercept.xml");
        context.start();
        /**
         * 服务调用
         */
    ...
    public void testClient_load_balance() throws Exception {
        ...
        ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("irpc-consumer-load-balance.xml");
        context.start();
        /**
         * 服务调用
         */
    ...
    public void testServer_telnet_manage() throws Exception {
        ...
        ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("irpc-provider-telnet-manage.xml");
        context.start();
        System.in.read();
    }
    ...
    public void testClient_telnet_manage() throws Exception {
        ...
        ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("irpc-consumer-telnet-manage.xml");
        context.start();
        System.in.read();
    }
    ...
    public void testClient_monitor() throws Exception {
        ...
        ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("irpc-consumer-monitor.xml");
        context.start();
        /**
         * 服务调用
         */
    ...
    public void testClient_base_rpc_context() throws Exception {
         ...
         */
        RpcContext.shadowParameterMap.get().put("name", "irpc");
    ...
    public void testServerAndClient_base() throws Exception {
        ...
        ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("irpc-provider-and-consumer.xml");
        context.start();
        /**
    ...
    public void testServer_full() throws Exception {
        ...
        ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("irpc-provider-full.xml");
        context.start();
        System.in.read();
    }
    ...
    public void testClient_full() throws Exception {
        ...
        ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("irpc-consumer-full.xml");
        context.start();
        /**
         * 服务调用
         */
